function changeImage(size) {
    ...
    if (size == '8') {
        productImage.src = 'assets/brands/panda/panda/Panda Triangels/17.webp';  // Image for 8 Pieces
    } else if (size == '16') {
        productImage.src = 'assets/brands/panda/panda/Panda Triangels/16.webp';  // Image for 16 Pieces
    }
}
...
let productTitles = {
    'white01': ['Feta Cheese','Istanbully Cheese', 'Baramily Cheese', 'Olive Cheese', 'Light Cheese'],
    'white02': ['Feta Cheese','Istanbully Cheese', 'Baramily Cheese', 'Olive Cheese', 'Light Cheese'],
    'white03': ['Feta Cheese','Istanbully Cheese', 'Baramily Cheese', 'Olive Cheese', 'Light Cheese']
};
